...
class TestMasterHeat(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.LCOH, self.CF, self.C_cap =master(model_name, location, RM=RM, t_storage=t_storage, P_load_des=500e3, r_pv=0.5, P_heater=1000e3, casedir=self.casedir, verbose=True, solcast_TMY=solcast_TMY)
    ...
    def test(self):
        ...
        self.assertTrue(abs(self.CF-0.592)/0.592<0.05)
