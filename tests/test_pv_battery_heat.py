...
class TestMasterHeat(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.LCOH, CF, CAPEX=master(model_name, location, RM=RM, t_storage=t_storage, P_load_des=500e3, bat_pmax=1000e3, casedir=self.casedir, verbose=True)
